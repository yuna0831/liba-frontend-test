...
export function TopMatchedButton({ className }: TopMatchedButtonProps) {
    return (
        /* 피그마 수치: W: 162px, H: 37px, Shadow 반영 */
        <div className={twMerge(clsx(
            "w-[162px] h-[37px] bg-white rounded-[31px]",
            "flex justify-center items-center gap-[10px] px-[18px] py-[8px]",
            "z-10 cursor-pointer transition-all duration-200 shadow-[0px_4px_4px_rgba(0,0,0,0.25)]",
            "hover:ring-2 hover:ring-[#B7FD33] border-none outline-none",
            className
        ))}>
